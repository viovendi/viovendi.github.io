...
function handler() {
    //option 1
    //var funkton1 = $$('.customization2_attendee_further-data_custom-question').findField('Welche Position hast du?');
    //console.log(funkton);
    //var select1 = $$('.customization2_attendee_further-data_custom-question').findField('Position im Unternehmen?');
