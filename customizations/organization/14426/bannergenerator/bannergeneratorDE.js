...
function setTexts() {
    ...
    if (value == 'horizontal') {
        ctx.fillText($('#halle_inp').val(), 385 - $('#halle_inp').val().length * 6, 45);
        ctx.fillText($('#stand_inp').val(), 425 - $('#stand_inp').val().length * 5, 45);
        ...
        ctx.fillText($('#halle_inp').val(), 400 - $('#halle_inp').val().length * 6, 1150);
        ctx.fillText($('#stand_inp').val(), 700 - $('#stand_inp').val().length * 9, 1150);
    }
}
