...
function setTexts() {
    ...
    if (value == 'horizontal') {
        ...
        ctx.fillText($('#halle_inp').val(), 78 - $('#halle_inp').val().length * 6, 485);
        ctx.fillText($('#stand_inp').val(), 78 - $('#stand_inp').val().length * 5, 565);
    } else if (value == 'email') {
        ctx.fillText($('#halle_inp').val(), 70 - $('#halle_inp').val().length * 6, 50);
        ctx.fillText($('#stand_inp').val(), 80, 50);
    } else if (value == 'instagrampost') {
        ctx.fillText($('#halle_inp').val(), 450 - $('#halle_inp').val().length * 6, 990);
        ctx.fillText($('#stand_inp').val(), 735 - $('#stand_inp').val().length * 9, 990);
        ...
        ctx.fillText($('#halle_inp').val(), 300 - $('#halle_inp').val().length * 6, 1050);
        ctx.fillText($('#stand_inp').val(), 600 - $('#stand_inp').val().length * 9, 1000);
    }
}
