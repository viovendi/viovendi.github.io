...
function setTexts() {
    ...
    if (value == 'horizontal') {
        ctx.fillText($('#halle_inp').val(), 250 - $('#halle_inp').val().length * 4, 49);
        ...
        ctx.fillText($('#stand_inp').val(), 820 - $('#stand_inp').val().length * 9, 1020);
    } else if (value == 'instagramstory') {
        ctx.fillText($('#halle_inp').val(), 510 - $('#halle_inp').val().length * 6, 1225);
        ctx.fillText($('#stand_inp').val(), 820 - $('#stand_inp').val().length * 9, 1225);
