...
function setTexts() {
    ...
    if (value == 'horizontal') {
        ctx.fillText($('#halle_inp').val(), 50 - $('#halle_inp').val().length * 4, 49);
        ctx.fillText($('#stand_inp').val(), 50 - $('#stand_inp').val().length * 4, 49);
        ...
        ctx.fillText($('#stand_inp').val(), 830 - $('#stand_inp').val().length * 9, 1020);
