...
function setTexts() {
    ...
    if (value == 'horizontal') {
        ctx.fillText($('#halle_inp').val(), 520 - $('#halle_inp').val().length * 4, 49);
        ctx.fillText($('#stand_inp').val(), 530 - $('#stand_inp').val().length * 4, 49);
        ...
        ctx.fillText($('#halle_inp').val(), 520 - $('#halle_inp').val().length * 6, 1025);
        ctx.fillText($('#stand_inp').val(), 800 - $('#stand_inp').val().length * 9, 1025);
    } else if (value == 'instagramstory') {
        ctx.fillText($('#halle_inp').val(), 510 - $('#halle_inp').val().length * 6, 1220);
        ctx.fillText($('#stand_inp').val(), 810 - $('#stand_inp').val().length * 9, 1220);
