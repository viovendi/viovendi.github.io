...
$('.event-article__event-info__title').each(function(i, element) {
  if($(this).text().indexOf('Brennholz') >= 0){
      ...
      console.log( $(this).closest('div.event-article__date-container__day > span:nth-child(2)').text())
      console.log( $(this).closest('div.event-article__date-container__day > span:nth-child(2)'))
