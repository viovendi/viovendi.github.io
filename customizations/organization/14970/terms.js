...
$('p.vv-text.vv-text__size--md.vv-text__weight--regular.vv-color--text:nth-child(2)').hide();

$('.vv-pl-lg.customization2_booking-terms_list').after('<div style="font-size: 14px;"><p>Die im Zeitraum der Veranstaltung gültigen Hygienevorschriften sind einzuhalten.</p></div>');
