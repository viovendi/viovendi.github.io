...
function setTexts() {
    ...
    if (value == 'horizontal') {
        ...
        ctx.fillText($('#stand_inp').val(), 320 - $('#stand_inp').val().length * 4, 31);
    } else if (value == 'vertikal') {
        ctx.fillText($('#halle_inp').val(), 90 - $('#halle_inp').val().length * 6, 520);
        ctx.fillText($('#stand_inp').val(), 90 - $('#stand_inp').val().length * 5, 580);
    } else if (value == 'email') {
