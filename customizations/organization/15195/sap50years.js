...
function hideStuff(name){
  ...
  if (ticketTitle == "Partner" ) {
    ...
    $('.'+name+' .customization2_attendee_contact-data_email').before('<span class= "addedHeading" >Falls ihr Partner auch bei der SAP arbeitet, bitte tragen Sie die SAP-Email-Adresse ein</span>');
  }
