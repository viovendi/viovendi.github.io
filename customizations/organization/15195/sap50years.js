...
function resetOtherTicket(ticketBlock) {
  ...
  if (getWidgetLang() == 'en') {
    $("#customization-booking-area-wrapper-page1 > vv-ticket-selection > div > div > div > form > ul > li:nth-child(3) > vv-ticket > div > div:nth-child(1) > div.col-xs-8.col-8 > div > p > vv-category-description > span").html('<p>Please note that only your own children are invited and all tickets are personalized. If you have more than 3 children that you would like to register, please send us an <a href="mailto:50years-wdf@sap.com?subject=Kind(er)%20registrieren&amp;body=Hallo%20Fritz,%0D%0A%0D%0Aich%20wollte%20nur%20sagen,%20dass%20" target="_blank">email</a>.</p>');
