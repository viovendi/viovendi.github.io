...
{
    window.open('mailto:50years-wdf@sap.com?subject=Register%20companion%2F%20additional%20children&body=Please%20note%20that%20only%20your%20own%20children%20are%20invited%20and%20all%20tickets%20are%20personalized.%20You%20are%20entitled%20to%20bring%20one%20companion%20only.%0D%0A%20%0D%0AWe%20need%20the%20following%20Contact%20Details.%0D%0A%20%0D%0AType%20%5BPartner%20%2F%20Child%5D%3A%0D%0AFirst%20name%3A%0D%0ALast%20name%3A%0D%0AAge%20%5B0-6%5D%5B7-15%5D%5B16-17%5D%5B%C3%9C18%5D%3A%0D%0AEmergency%20contact%20number%20(optional)%3A', '_blank');
...
async function getInfo() {
  ...
  //TODO
  if (getWidgetLang() == 'en') {
  var element = $('.customization3_edit-booking_header').after('<div class= "addedHeading" style="font-size:14px;padding: 20px;font-family: inherit;color: #343a3f;">available Tickets on Saturday:' + amtountArray[0] + " --- available Tickets Sunday: " + amtountArray[1] + '</div><div class= "addedHeading" style="font-size:14px;padding: 20px;font-family: inherit;color: #343a3f;">Please note that you cant add or cancel any attendees on this page. Should you want to add or cancel any attendees, please send an email to 50years-wdf@sap.com</div><div><button class="vv-button vv-button-secondary vv-button-secondary-red vv-text__size--lg customMailIconButton" style="margin:24px;background: url(\'https://doo-product-consulting-uploads.s3.eu-central-1.amazonaws.com/SAP+Now/mail_Icon.png\') no-repeat;padding-left: 55px;background-size: 25px;background-position: 20px center" onclick="storno();" type="button">cancel individual attendees</button><button class="vv-button vv-button-secondary vv-button-secondary-red vv-text__size--lg customMailIconButton" style="margin:24px;background: url(\'https://doo-product-consulting-uploads.s3.eu-central-1.amazonaws.com/SAP+Now/mail_Icon.png\') no-repeat;padding-left: 55px;background-size: 25px;background-position: 20px center"onclick="sendEmailChild();" type="button">add a companion or additional children</button></div>'
  );
  }
  else{
  var element = $('.customization3_edit-booking_header').after('<div class= "addedHeading" style="font-size:14px;padding: 20px;font-family: inherit;color: #343a3f;">verfügbare Tickets Samstag:' + amtountArray[0] + " --- verfügbare Tickets Sonntag: " + amtountArray[1] + '</div><div class= "addedHeading" style="font-size:14px;padding: 20px;font-family: inherit;color: #343a3f;">Bitte beachte, dass du an dieser Stelle keine Personen hinzufügen oder stornieren kannst. Schreibe hierfür bitte eine E-Mail an 50years-wdf@sap.com</div><div><button class="vv-button vv-button-secondary vv-button-secondary-red vv-text__size--lg customMailIconButton" style="margin:24px;background: url(\'https://doo-product-consulting-uploads.s3.eu-central-1.amazonaws.com/SAP+Now/mail_Icon.png\') no-repeat;padding-left: 55px;background-size: 25px;background-position: 20px center" onclick="storno();" type="button">einzelne Personen stornieren</button><button class="vv-button vv-button-secondary vv-button-secondary-red vv-text__size--lg customMailIconButton" style="margin:24px;background: url(\'https://doo-product-consulting-uploads.s3.eu-central-1.amazonaws.com/SAP+Now/mail_Icon.png\') no-repeat;padding-left: 55px;background-size: 25px;background-position: 20px center"onclick="sendEmailChild();" type="button">Begleiterson/ weiteres Kind registrieren</button></div>'
  );
  }
