...
function hideStuff(name){
  ...
  if (ticketTitle == "Partner" ) {
    ...
    $('.'+name+' .customization2_attendee_contact-data_email').before('<span class= "addedHeading" style="color:#343a3f">Falls ihr Partner auch bei der SAP arbeitet, bitte tragen Sie die SAP-Email-Adresse ein</span>');
  }
