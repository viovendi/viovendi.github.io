...
const imageNameAndURL = [
  ['vertikal', 'https://viovendi.github.io/customizations/organization/15267/bannergenerator/VF23_Ausstellerbanner_160x600_D_RZ.png'],
  ['horizontal', 'https://viovendi.github.io/customizations/organization/15267/bannergenerator/VF23_Ausstellerbanner_468x60_D_RZ.png'],
  ['email', 'https://viovendi.github.io/customizations/organization/15267/bannergenerator/VF23_Ausstellerbanner_180x60_D_RZ.png'],
  ['instagrampost', 'https://viovendi.github.io/customizations/organization/15267/bannergenerator/VF23_Ausstellerbanner_1080x1080_D_RZ.png'],
  ['instagramstory', 'https://viovendi.github.io/customizations/organization/15267/bannergenerator/VF23_Ausstellerbanner_1080x1350_D_RZ.png'],
  ['facebook', 'https://viovendi.github.io/customizations/organization/15267/bannergenerator/VF23_Ausstellerbanner_1080x1350_D_RZ.png']
];
...
function setTexts() {
    ...
    if (value == 'horizontal') {
        ...
        ctx.fillText($('#halle_inp').val(), 78 - $('#halle_inp').val().length * 6, 520);
        ...
        ctx.fillText($('#halle_inp').val(), 510 - $('#halle_inp').val().length * 6, 1226);
        ctx.fillText($('#stand_inp').val(), 835 - $('#stand_inp').val().length * 9, 1226);
