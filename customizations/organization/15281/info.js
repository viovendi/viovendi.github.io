...
function handler(){
    ...
    var newInfo;
    if(window.location.href.includes("https://doo.net/de-de/")){
        newInfo = `<vv-tooltip _ngcontent-hfv-c179="" standalone="">
      ...
      <!---->
        ...
        <div class="vv-tooltip vv-tooltip__size--md vv-tooltip__skin--default vv-tooltip__position--bottom">
          ...
          Please enter the <u>exact</u> company name of your law firm here!
