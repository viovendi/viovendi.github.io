...
$(document).ready(function () {
    ...
    function emailConfirmationAttendee() {
        ...
        $('.customization2_attendee_contact-data_email-confirmation_input').focus().click();
        $('.customization2_attendee_edit-action_save').focus().click();
    };
    ...
    function emailConfirmationBooker() {
        ...
        box2.val(box1.val());
        $('.customization2_booker_contact-data_email-confirmation_input').focus().click();
        $('.customization2_booker_edit-action_save').focus().click();
    };
    ...
    function moveTerms() {
        ...
        var terms = "<p id='45408464531'>Die <a style='color: #3b9f9a !important' href='https://sz-erleben.sueddeutsche.de/agb#teilnahmebedingungen' target='_blank' rel='noopener noreferrer'>Teilnahmebedingungen</a>, <a style='color: #3b9f9a !important' href='https://www.swmh-datenschutz.de/sz-erleben' target='_blank' rel='noopener noreferrer'>Datenschutzhinweise</a> und <a style='color: #3b9f9a !important' href='https://www.swmh-datenschutz.de/sz-erleben#Gewinnspiele' target='_blank' rel='noopener noreferrer'>Widerruf</a> habe ich zur Kenntnis genommen.</p>";
