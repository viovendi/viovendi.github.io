...
function showWorkshopblock(workshopblock, wrapper){
  $(workshopblock).each( function(i, element) {
    var product = $$('.'+wrapper+' .customization2_attendee_further-data_product').findField(element);
    var question = $$('.'+wrapper+' .customization2_attendee_further-data_custom-question').findField(element);
    console.log(element);
...
function main(wrapper){
    ...
    $(product1).before('<span class= "workshops" onclick = "showWorkshopblock(workshopblock1, wrapper);">Montag, 25. Oktober 2021 ▼</span>');
    ...
    $(product2).before('<span class= "workshops" onclick = "showWorkshopblock(workshopblock2, wrapper);">Dienstag, 26 Oktober 2021▼</span>');
    ...
    $(product3).before('<span class= "workshops" onclick = "showWorkshopblock(workshopblock3, wrapper);">Mittwoch, 27. Oktober 2021 ▼</span>');
    ...
    $(product4).before('<span class= "workshops" onclick = "showWorkshopblock(workshopblock4, wrapper);">Donnerstag, 28. Oktober 2021 ▼</span>');
    ...
    $(product5).before('<span class= "workshops" onclick = "showWorkshopblock(workshopblock5, wrapper);">Freitag, 29. Oktober 2021 ▼</span>');
    ...
    $(product6).before('<span class= "workshops" onclick = "showWorkshopblock(workshopblock6, wrapper);">Dienstag, 02. November 2021 ▼</span>');
    ...
    $(product7).before('<span class= "workshops" onclick = "showWorkshopblock(workshopblock7, wrapper);">Mittwoch, 03. November 2021 ▼</span>');
    ...
    $(product8).before('<span class= "workshops" onclick = "showWorkshopblock(workshopblock8, wrapper);">Donnerstag, 04. November 2021 ▼</span>');
    ...
    $(product9).before('<span class= "workshops" onclick = "showWorkshopblock(workshopblock9, wrapper);">Freitag, 05. November 2021 ▼</span>');
}
main();
