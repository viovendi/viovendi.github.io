...
const imageNameAndURL = [
  ['vertikal', 'https://viovendi.github.io/customizations/organization/15396/bannergenerator/2023_ET_Webbanner_Aussteller_160x600_D.png'],
...
function setTexts() {
    ...
    if (value == 'horizontal') {
        ...
        ctx.fillText($('#halle_inp').val(), 85 - $('#halle_inp').val().length * 6, 490);
        ctx.fillText($('#stand_inp').val(), 90 - $('#stand_inp').val().length * 5, 560);
    } else if (value == 'email') {
