async function run(ticket, value) {
    ...
    ctrl.click();
    const panel = await custom_js.waitForCreate(() => ctrl.find("p-overlay .p-dropdown-panel"), ctrl);
    ...
    await custom_js.waitForDelete(() => ctrl.find("p-overlay .p-dropdown-panel"), ctrl);
